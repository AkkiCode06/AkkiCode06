<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:000000,100:FF4D00&height=200&section=header&text=Akshat%20Barjatya&fontSize=50&fontColor=fff&animation=fadeIn" />

<div align="center">

### Computer Science with Innovation Student | Bristol, England, United Kingdom

grew up in dubai, now studying cs at bristol (2029). i ship things — ai tools, fintech products, whatever problem's in front of me. currently obsessed with llms, rag systems, and making ai actually useful for real people.
the goal? build products that matter in mena and beyond. i want to be in the room where fintech and ai collide — founding, building, shipping. long-term: something of my own that genuinely changes how people interact with money and information. for now, i'm pacing myself by doing: learning through shipping, not through studying.
i don't separate work from curiosity — they feed each other. a flight i obsess over teaches me about systems and constraints. a vfx project teaches me about detail and patience. a market i've never touched teaches me what people actually need versus what i assume they need. it all compounds.
what i'm really after is leverage — the kind that comes from understanding both the technical and the human side of a problem. anyone can build a feature. fewer people can see why it matters, who it's for, and what happens when it scales. that's the gap i'm trying to live in.
i move fast but i'm playing a long game. dubai gave me the ambition, bristol's giving me the foundations, and everything in between is just reps. by the time the right idea and the right moment line up, i want to be the person ready to build it — not the one still figuring out where to start.
when i'm not at my desk — i'm in the sky (huge aviation nerd), deep in a gfx/vfx project, or travelling somewhere that forces a new perspective. i believe the best builders are also curious about everything else.
so if you're working on something at the edge of fintech, ai, or just a genuinely hard problem worth solving — let's talk.
...
- 📚 Learning: **Machine Learning, Cybersecurity, Fintech**
- 🤝 Open to collaborate on: **Projects in security, finance, design, and creative coding**
- 💬 Ask me about: **Cybersecurity, Fintech, Machine Learning**
...
⚡ I am a massive aviation enthusiast and enjoy experimenting with GFX and VFX.

</div>

<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:000000,100:FF4D00&height=100&section=footer" />
